(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! /home/faiza/Documents/todo-list/frontend/src/main.ts */
      "zUnb");
      /***/
    },
    ...
    /***/
    function WmK(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var TodoListService = /*#__PURE__*/function () {
        ...
        _createClass(TodoListService, [{
          ...
          key: "GetTodo_list",
          value: function GetTodo_list(id) {
            return this.http.get("".concat(this.baseUrl, "/").concat(id));
          }
        }, {
          key: "GetSalarier_by_date",
          value: function GetSalarier_by_date(id, annee, mois) {
            return this.http.get("".concat(this.baseUrl, "/date/").concat(id, "/").concat(annee, "/").concat(mois));
          }
        }, {
          key: "CreateTodo_list",
          value: function CreateTodo_list(todo_list) {
            return this.http.post("".concat(this.baseUrl), todo_list);
          }
        }, {
          key: "CreateSalarier_with_service",
          value: function CreateSalarier_with_service(salarier, service_id) {
            return this.http.post("".concat(this.baseUrl, "/add_with_service/").concat(service_id), salarier);
          }
        }, {
          key: "CreateTodo_list_with_categorie",
          value: function CreateTodo_list_with_categorie(todo_list, categorie_id) {
            return this.http.post("".concat(this.baseUrl, "/post_with_categorie/").concat(categorie_id), todo_list);
          }
        }, {
          key: "Update_salarier_avec_service",
          value: function Update_salarier_avec_service(pk, service_id, value) {
            return this.http.put("".concat(this.baseUrl, "/salarier_put_with_service/").concat(pk, "/").concat(service_id), value);
          }
        }, {
          key: "Update_salarier_avec_poste",
          value: function Update_salarier_avec_poste(pk, service_id, value) {
            return this.http.put("".concat(this.baseUrl, "/put_with_poste/").concat(pk, "/").concat(service_id), value);
          }
        }, {
          key: "UpdateTodo_list",
          value: function UpdateTodo_list(id, value) {
            return this.http.put("".concat(this.baseUrl, "/").concat(id), value);
          }
        }, {
          key: "DeleteSalarier_du_serv",
          value: function DeleteSalarier_du_serv(id) {
            return this.http.get("".concat(this.baseUrl, "/effacer_sal_du_serv/").concat(id));
          }
        }, {
          key: "DeleteTodo_list",
          value: function DeleteTodo_list(id) {
            return this.http["delete"]("".concat(this.baseUrl, "/").concat(id));
          }
        }, {
          key: "GetTodo_list_List",
          value: function GetTodo_list_List() {
            return this.http.get("".concat(this.baseUrl));
          }
        }, {
          key: "deleteAll",
          value: function deleteAll() {
            return this.http["delete"]("".concat(this.baseUrl));
          }
        }]);
    ...
    /***/
    function fFJ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "TwodigitdecimalnumberDirective", function () {
      ...
      var TwodigitdecimalnumberDirective = /*#__PURE__*/function () {
        function TwodigitdecimalnumberDirective(el) {
          _classCallCheck(this, TwodigitdecimalnumberDirective);
        ...
        _createClass(TwodigitdecimalnumberDirective, [{
          key: "onKeyDown",
      ...
      TwodigitdecimalnumberDirective.ɵfac = function TwodigitdecimalnumberDirective_Factory(t) {
        return new (t || TwodigitdecimalnumberDirective)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"]));
      };

      TwodigitdecimalnumberDirective.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({
        ...
        hostBindings: function TwodigitdecimalnumberDirective_HostBindings(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("keydown", function TwodigitdecimalnumberDirective_keydown_HostBindingHandler($event) {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TwodigitdecimalnumberDirective, [{
    ...
    /***/
    function GszS(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var CustomMatPaginatorIntl = /*#__PURE__*/function (_angular_material_pag) {
        ...
        function CustomMatPaginatorIntl() {
          ...
          _this.getRangeLabel = function (page, pageSize, length) {
            ...
            return "".concat(startIndex + 1, " - ").concat(endIndex, " / ").concat(length);
          };
      ...
      CustomMatPaginatorIntl.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CustomMatPaginatorIntl, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"]
        }], function () {
          return [];
        }, null);
    ...
    /***/
    function MUi6(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _todo_list_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ../todo-list.service */
      "3WmK");
      /* harmony import */


      var _categorie_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../categorie.service */
      "hglL");
      /* harmony import */
      ...
      function TodoListComponent_tr_11_Template(rf, ctx) {
        if (rf & 1) {
          var _r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "tr", 29);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TodoListComponent_tr_11_Template_tr_click_0_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7);

            var todo_r5 = ctx.$implicit;

            var ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r6.onSelect(todo_r5);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TodoListComponent_tr_11_Template_button_click_4_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7);
            ...
            return ctx_r8.onSelect(todo_r5);
          });
      ...
      function TodoListComponent_div_35_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 33);
      ...
      function TodoListComponent_mat_option_40_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function TodoListComponent_form_57_div_5_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function TodoListComponent_form_57_div_10_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 38);
      ...
      function TodoListComponent_form_57_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function TodoListComponent_form_57_Template_input_ngModelChange_4_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13);

            var ctx_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r12.tache_by_id.titre = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function TodoListComponent_form_57_Template_input_ngModelChange_9_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13);

            var ctx_r14 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r14.tache_by_id.a_faire = $event;
          });
      ...
      var TodoListComponent = /*#__PURE__*/function () {
        function TodoListComponent(todo_fb, todo_list, categorie) {
        ...
        _createClass(TodoListComponent, [{
          ...
          key: "onSelect",
          value: function onSelect(todo) {
            this.selectedTache = todo.id; // this.i_selection= salarier.item
          ...
          value: function Add_todo_list() {
            ...
            if (!this.todo_form.valid) {
              ...
              if (this.categorie_id) {
                this.todo_list.CreateTodo_list_with_categorie(this.categorie_id, this.todo_form.value).subscribe(function (response) {
                  return console.log(response);
                }, function (error) {
                  return console.log(error);
                });
              } else {
                this.todo_list.CreateTodo_list(this.todo_form.value).subscribe(function (response) {
                  return console.log(response);
                }, function (error) {
                  return console.log(error);
                });
          ...
          key: "Update_Todo_list",
          value: function Update_Todo_list() {
            ...
            if (!this.todo_form.valid) {
              ...
              this.todo_list.UpdateTodo_list(this.selectedTache, this.todo_form.value).subscribe(function (response) {
                return console.log(response);
              }, function (error) {
                return console.log(error);
              });
          ...
          key: "GetTodo_list_by_id",
          value: function GetTodo_list_by_id() {
            var _this2 = this;

            this.todo_list.GetTodo_list(this.selectedTache).subscribe(function (data) {
              _this2.tache_by_id = data;
            }, function (error) {
              return console.log(error);
            });
          }
        }, {
          key: "Delete_Todo_list",
          value: function Delete_Todo_list() {
            //il faut récupérer l'id lors de la séléction de la todo list pour la modifier 
            var id;
            this.todo_list.DeleteTodo_list(this.selectedTache).subscribe(function (response) {
              return console.log(response);
            }, function (error) {
              return console.log(error);
            });
          ...
          key: "Read_Todo_list",
          value: function Read_Todo_list() {}
        }, {
          key: "Add_categorie",
          value: function Add_categorie() {}
        }, {
          key: "Delete_categorie",
          value: function Delete_categorie() {}
        }, {
          key: "myForm",
          get: function get() {
      ...
      TodoListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function TodoListComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](7, "Cat\xE9gorie ");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](38, "Cat\xE9gorie");

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](39, "mat-select", 21);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectionChange", function TodoListComponent_Template_mat_select_selectionChange_39_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](43, "Affecter a une ct\xE9gorie ");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TodoListComponent_Template_button_click_45_listener() {
              return ctx.Add_todo_list();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TodoListComponent_Template_button_click_59_listener() {
              return ctx.Update_Todo_list();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TodoListComponent_Template_button_click_61_listener() {
              return ctx.Delete_Todo_list();
            });
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TodoListComponent, [{
          ...
          return [{
            ...
            type: _todo_list_service__WEBPACK_IMPORTED_MODULE_2__["TodoListService"]
          }, {
            type: _categorie_service__WEBPACK_IMPORTED_MODULE_3__["CategorieService"]
          }];
        }, {
          tache_by_id: [{
    ...
    function ZAI4(module, __webpack_exports__, __webpack_require__) {
      ...
      var ngx_print__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ngx-print */
      "m1XX");
      /* harmony import */
      ...
      var _angular_cdk_overlay__WEBPACK_IMPORTED_MODULE_49__ = __webpack_require__(
      /*! @angular/cdk/overlay */
      "rDax");
      /* harmony import */


      var ngconf_search__WEBPACK_IMPORTED_MODULE_50__ = __webpack_require__(
      /*! ngconf-search */
      "IV5+");
      /* harmony import */


      var ngx_pagination__WEBPACK_IMPORTED_MODULE_51__ = __webpack_require__(
      /*! ngx-pagination */
      "oOf3");
      /* harmony import */


      var ng2_search_filter__WEBPACK_IMPORTED_MODULE_52__ = __webpack_require__(
      /*! ng2-search-filter */
      "cZdB");
      /* harmony import */


      var _angular_cdk_layout__WEBPACK_IMPORTED_MODULE_53__ = __webpack_require__(
      /*! @angular/cdk/layout */
      "0MNC");
      /* harmony import */


      var ngx_filter_pipe__WEBPACK_IMPORTED_MODULE_54__ = __webpack_require__(
      /*! ngx-filter-pipe */
      "VADE");
      /* harmony import */


      var _filter_contact_pipe__WEBPACK_IMPORTED_MODULE_55__ = __webpack_require__(
      /*! ./filter-contact.pipe */
      "jXNY");
      /* harmony import */


      var angular_datatables__WEBPACK_IMPORTED_MODULE_56__ = __webpack_require__(
      /*! angular-datatables */
      "njyG");
      /* harmony import */


      var ngx_sortable__WEBPACK_IMPORTED_MODULE_57__ = __webpack_require__(
      /*! ngx-sortable */
      "KjBr");
      /* harmony import */


      var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_58__ = __webpack_require__(
      /*! @ng-bootstrap/ng-bootstrap */
      "1kSV");
      /* harmony import */


      var ngx_order_pipe__WEBPACK_IMPORTED_MODULE_59__ = __webpack_require__(
      /*! ngx-order-pipe */
      "JMRq");
      /* harmony import */


      var _custom_mat_paginator_init__WEBPACK_IMPORTED_MODULE_60__ = __webpack_require__(
      /*! ./custom-mat-paginator-init */
      "GszS");
      /* harmony import */


      var ngx_mat_tag_input__WEBPACK_IMPORTED_MODULE_61__ = __webpack_require__(
      /*! ngx-mat-tag-input */
      "PCNm");
      /* harmony import */


      var _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_62__ = __webpack_require__(
      /*! @angular/cdk/scrolling */
      "vxfF");
      /* harmony import */


      var ng_table_virtual_scroll__WEBPACK_IMPORTED_MODULE_63__ = __webpack_require__(
      /*! ng-table-virtual-scroll */
      "S2gQ");
      /* harmony import */


      var angular_ng_autocomplete__WEBPACK_IMPORTED_MODULE_64__ = __webpack_require__(
      /*! angular-ng-autocomplete */
      "bH2/");
      /* harmony import */


      var ngx_bootstrap_datepicker__WEBPACK_IMPORTED_MODULE_65__ = __webpack_require__(
      /*! ngx-bootstrap/datepicker */
      "hzby");
      /* harmony import */


      var _twodigitdecimalnumber_directive__WEBPACK_IMPORTED_MODULE_66__ = __webpack_require__(
      /*! ./twodigitdecimalnumber.directive */
      "4fFJ");
      /* harmony import */


      var ngx_barcode__WEBPACK_IMPORTED_MODULE_67__ = __webpack_require__(
      /*! ngx-barcode */
      "6QD7");
      /* harmony import */


      var _todo_list_todo_list_component__WEBPACK_IMPORTED_MODULE_68__ = __webpack_require__(
      /*! ./todo-list/todo-list.component */
      "MUi6");
      /* harmony import */


      var _todo_list_service__WEBPACK_IMPORTED_MODULE_69__ = __webpack_require__(
      /*! ./todo-list.service */
      "3WmK");
      /* harmony import */


      var _categorie_service__WEBPACK_IMPORTED_MODULE_70__ = __webpack_require__(
      /*! ./categorie.service */
      "hglL"); //import { Routes, RouterModule,CanActivate } from '@angular/router';
      ...
      AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
        ...
        }, _todo_list_service__WEBPACK_IMPORTED_MODULE_69__["TodoListService"], _categorie_service__WEBPACK_IMPORTED_MODULE_70__["CategorieService"]],
        imports: [[ngx_print__WEBPACK_IMPORTED_MODULE_6__["NgxPrintModule"], ngx_barcode__WEBPACK_IMPORTED_MODULE_67__["NgxBarcodeModule"], ngx_bootstrap_datepicker__WEBPACK_IMPORTED_MODULE_65__["BsDatepickerModule"].forRoot(), ngx_bootstrap_datepicker__WEBPACK_IMPORTED_MODULE_65__["DatepickerModule"].forRoot(), angular_ng_autocomplete__WEBPACK_IMPORTED_MODULE_64__["AutocompleteLibModule"], ngx_mat_tag_input__WEBPACK_IMPORTED_MODULE_61__["NgxMatTagInputModule"], ng_table_virtual_scroll__WEBPACK_IMPORTED_MODULE_63__["TableVirtualScrollModule"], angular_datatables__WEBPACK_IMPORTED_MODULE_56__["DataTablesModule"], ngx_order_pipe__WEBPACK_IMPORTED_MODULE_59__["OrderModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_58__["NgbPaginationModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_58__["NgbModule"], ngx_filter_pipe__WEBPACK_IMPORTED_MODULE_54__["FilterPipeModule"], ngconf_search__WEBPACK_IMPORTED_MODULE_50__["NgconfSearchModule"], ngx_pagination__WEBPACK_IMPORTED_MODULE_51__["NgxPaginationModule"], ngx_sortable__WEBPACK_IMPORTED_MODULE_57__["NgxSortableModule"], _angular_material_slider__WEBPACK_IMPORTED_MODULE_40__["MatSliderModule"], _angular_material_autocomplete__WEBPACK_IMPORTED_MODULE_16__["MatAutocompleteModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_31__["MatInputModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_7__["BrowserAnimationsModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_19__["MatButtonModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_38__["MatSelectModule"], _angular_material_radio__WEBPACK_IMPORTED_MODULE_37__["MatRadioModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_21__["MatCardModule"], _angular_material_grid_list__WEBPACK_IMPORTED_MODULE_29__["MatGridListModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_33__["MatMenuModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_30__["MatIconModule"], _angular_cdk_layout__WEBPACK_IMPORTED_MODULE_53__["LayoutModule"], // RouterModule,
        ng2_search_filter__WEBPACK_IMPORTED_MODULE_52__["Ng2SearchPipeModule"], //
        _angular_cdk_a11y__WEBPACK_IMPORTED_MODULE_9__["A11yModule"], _angular_cdk_clipboard__WEBPACK_IMPORTED_MODULE_10__["ClipboardModule"], _angular_cdk_stepper__WEBPACK_IMPORTED_MODULE_13__["CdkStepperModule"], _angular_cdk_table__WEBPACK_IMPORTED_MODULE_14__["CdkTableModule"], _angular_cdk_tree__WEBPACK_IMPORTED_MODULE_15__["CdkTreeModule"], _angular_cdk_drag_drop__WEBPACK_IMPORTED_MODULE_11__["DragDropModule"], _angular_material_autocomplete__WEBPACK_IMPORTED_MODULE_16__["MatAutocompleteModule"], _angular_material_badge__WEBPACK_IMPORTED_MODULE_17__["MatBadgeModule"], _angular_material_bottom_sheet__WEBPACK_IMPORTED_MODULE_18__["MatBottomSheetModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_19__["MatButtonModule"], _angular_material_button_toggle__WEBPACK_IMPORTED_MODULE_20__["MatButtonToggleModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_21__["MatCardModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_22__["MatCheckboxModule"], _angular_material_chips__WEBPACK_IMPORTED_MODULE_23__["MatChipsModule"], _angular_material_stepper__WEBPACK_IMPORTED_MODULE_24__["MatStepperModule"], _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_25__["MatDatepickerModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_26__["MatDialogModule"], _angular_material_divider__WEBPACK_IMPORTED_MODULE_27__["MatDividerModule"], _angular_material_expansion__WEBPACK_IMPORTED_MODULE_28__["MatExpansionModule"], _angular_material_grid_list__WEBPACK_IMPORTED_MODULE_29__["MatGridListModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_30__["MatIconModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_31__["MatInputModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_32__["MatListModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_33__["MatMenuModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_34__["MatNativeDateModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_8__["MatPaginatorModule"], _angular_material_progress_bar__WEBPACK_IMPORTED_MODULE_35__["MatProgressBarModule"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_36__["MatProgressSpinnerModule"], _angular_material_radio__WEBPACK_IMPORTED_MODULE_37__["MatRadioModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_34__["MatRippleModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_38__["MatSelectModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_39__["MatSidenavModule"], _angular_material_slider__WEBPACK_IMPORTED_MODULE_40__["MatSliderModule"], _angular_material_slide_toggle__WEBPACK_IMPORTED_MODULE_41__["MatSlideToggleModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_42__["MatSnackBarModule"], _angular_material_sort__WEBPACK_IMPORTED_MODULE_43__["MatSortModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_44__["MatTableModule"], _angular_material_tabs__WEBPACK_IMPORTED_MODULE_45__["MatTabsModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_46__["MatToolbarModule"], _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_47__["MatTooltipModule"], _angular_material_tree__WEBPACK_IMPORTED_MODULE_48__["MatTreeModule"], _angular_cdk_overlay__WEBPACK_IMPORTED_MODULE_49__["OverlayModule"], _angular_cdk_portal__WEBPACK_IMPORTED_MODULE_12__["PortalModule"], _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_62__["ScrollingModule"]], //RouterModule,
        _angular_cdk_a11y__WEBPACK_IMPORTED_MODULE_9__["A11yModule"], _angular_cdk_clipboard__WEBPACK_IMPORTED_MODULE_10__["ClipboardModule"], _angular_cdk_stepper__WEBPACK_IMPORTED_MODULE_13__["CdkStepperModule"], _angular_cdk_table__WEBPACK_IMPORTED_MODULE_14__["CdkTableModule"], _angular_cdk_tree__WEBPACK_IMPORTED_MODULE_15__["CdkTreeModule"], _angular_cdk_drag_drop__WEBPACK_IMPORTED_MODULE_11__["DragDropModule"], _angular_material_autocomplete__WEBPACK_IMPORTED_MODULE_16__["MatAutocompleteModule"], _angular_material_badge__WEBPACK_IMPORTED_MODULE_17__["MatBadgeModule"], _angular_material_bottom_sheet__WEBPACK_IMPORTED_MODULE_18__["MatBottomSheetModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_19__["MatButtonModule"], _angular_material_button_toggle__WEBPACK_IMPORTED_MODULE_20__["MatButtonToggleModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_21__["MatCardModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_22__["MatCheckboxModule"], _angular_material_chips__WEBPACK_IMPORTED_MODULE_23__["MatChipsModule"], _angular_material_stepper__WEBPACK_IMPORTED_MODULE_24__["MatStepperModule"], _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_25__["MatDatepickerModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_26__["MatDialogModule"], _angular_material_divider__WEBPACK_IMPORTED_MODULE_27__["MatDividerModule"], _angular_material_expansion__WEBPACK_IMPORTED_MODULE_28__["MatExpansionModule"], _angular_material_grid_list__WEBPACK_IMPORTED_MODULE_29__["MatGridListModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_30__["MatIconModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_31__["MatInputModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_32__["MatListModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_33__["MatMenuModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_34__["MatNativeDateModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_8__["MatPaginatorModule"], _angular_material_progress_bar__WEBPACK_IMPORTED_MODULE_35__["MatProgressBarModule"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_36__["MatProgressSpinnerModule"], _angular_material_radio__WEBPACK_IMPORTED_MODULE_37__["MatRadioModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_34__["MatRippleModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_38__["MatSelectModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_39__["MatSidenavModule"], _angular_material_slider__WEBPACK_IMPORTED_MODULE_40__["MatSliderModule"], _angular_material_slide_toggle__WEBPACK_IMPORTED_MODULE_41__["MatSlideToggleModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_42__["MatSnackBarModule"], _angular_material_sort__WEBPACK_IMPORTED_MODULE_43__["MatSortModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_44__["MatTableModule"], _angular_material_tabs__WEBPACK_IMPORTED_MODULE_45__["MatTabsModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_46__["MatToolbarModule"], _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_47__["MatTooltipModule"], _angular_material_tree__WEBPACK_IMPORTED_MODULE_48__["MatTreeModule"], _angular_cdk_overlay__WEBPACK_IMPORTED_MODULE_49__["OverlayModule"], _angular_cdk_portal__WEBPACK_IMPORTED_MODULE_12__["PortalModule"], _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_62__["ScrollingModule"]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
          declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _twodigitdecimalnumber_directive__WEBPACK_IMPORTED_MODULE_66__["TwodigitdecimalnumberDirective"], _filter_contact_pipe__WEBPACK_IMPORTED_MODULE_55__["FilterContactPipe"], _todo_list_todo_list_component__WEBPACK_IMPORTED_MODULE_68__["TodoListComponent"]],
          imports: [ngx_print__WEBPACK_IMPORTED_MODULE_6__["NgxPrintModule"], ngx_barcode__WEBPACK_IMPORTED_MODULE_67__["NgxBarcodeModule"], ngx_bootstrap_datepicker__WEBPACK_IMPORTED_MODULE_65__["BsDatepickerModule"], ngx_bootstrap_datepicker__WEBPACK_IMPORTED_MODULE_65__["DatepickerModule"], angular_ng_autocomplete__WEBPACK_IMPORTED_MODULE_64__["AutocompleteLibModule"], ngx_mat_tag_input__WEBPACK_IMPORTED_MODULE_61__["NgxMatTagInputModule"], ng_table_virtual_scroll__WEBPACK_IMPORTED_MODULE_63__["TableVirtualScrollModule"], angular_datatables__WEBPACK_IMPORTED_MODULE_56__["DataTablesModule"], ngx_order_pipe__WEBPACK_IMPORTED_MODULE_59__["OrderModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_58__["NgbPaginationModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_58__["NgbModule"], ngx_filter_pipe__WEBPACK_IMPORTED_MODULE_54__["FilterPipeModule"], ngconf_search__WEBPACK_IMPORTED_MODULE_50__["NgconfSearchModule"], ngx_pagination__WEBPACK_IMPORTED_MODULE_51__["NgxPaginationModule"], ngx_sortable__WEBPACK_IMPORTED_MODULE_57__["NgxSortableModule"], _angular_material_slider__WEBPACK_IMPORTED_MODULE_40__["MatSliderModule"], _angular_material_autocomplete__WEBPACK_IMPORTED_MODULE_16__["MatAutocompleteModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_31__["MatInputModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_7__["BrowserAnimationsModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_19__["MatButtonModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_38__["MatSelectModule"], _angular_material_radio__WEBPACK_IMPORTED_MODULE_37__["MatRadioModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_21__["MatCardModule"], _angular_material_grid_list__WEBPACK_IMPORTED_MODULE_29__["MatGridListModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_33__["MatMenuModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_30__["MatIconModule"], _angular_cdk_layout__WEBPACK_IMPORTED_MODULE_53__["LayoutModule"], // RouterModule,
          ng2_search_filter__WEBPACK_IMPORTED_MODULE_52__["Ng2SearchPipeModule"], //
          _angular_cdk_a11y__WEBPACK_IMPORTED_MODULE_9__["A11yModule"], _angular_cdk_clipboard__WEBPACK_IMPORTED_MODULE_10__["ClipboardModule"], _angular_cdk_stepper__WEBPACK_IMPORTED_MODULE_13__["CdkStepperModule"], _angular_cdk_table__WEBPACK_IMPORTED_MODULE_14__["CdkTableModule"], _angular_cdk_tree__WEBPACK_IMPORTED_MODULE_15__["CdkTreeModule"], _angular_cdk_drag_drop__WEBPACK_IMPORTED_MODULE_11__["DragDropModule"], _angular_material_autocomplete__WEBPACK_IMPORTED_MODULE_16__["MatAutocompleteModule"], _angular_material_badge__WEBPACK_IMPORTED_MODULE_17__["MatBadgeModule"], _angular_material_bottom_sheet__WEBPACK_IMPORTED_MODULE_18__["MatBottomSheetModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_19__["MatButtonModule"], _angular_material_button_toggle__WEBPACK_IMPORTED_MODULE_20__["MatButtonToggleModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_21__["MatCardModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_22__["MatCheckboxModule"], _angular_material_chips__WEBPACK_IMPORTED_MODULE_23__["MatChipsModule"], _angular_material_stepper__WEBPACK_IMPORTED_MODULE_24__["MatStepperModule"], _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_25__["MatDatepickerModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_26__["MatDialogModule"], _angular_material_divider__WEBPACK_IMPORTED_MODULE_27__["MatDividerModule"], _angular_material_expansion__WEBPACK_IMPORTED_MODULE_28__["MatExpansionModule"], _angular_material_grid_list__WEBPACK_IMPORTED_MODULE_29__["MatGridListModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_30__["MatIconModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_31__["MatInputModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_32__["MatListModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_33__["MatMenuModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_34__["MatNativeDateModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_8__["MatPaginatorModule"], _angular_material_progress_bar__WEBPACK_IMPORTED_MODULE_35__["MatProgressBarModule"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_36__["MatProgressSpinnerModule"], _angular_material_radio__WEBPACK_IMPORTED_MODULE_37__["MatRadioModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_34__["MatRippleModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_38__["MatSelectModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_39__["MatSidenavModule"], _angular_material_slider__WEBPACK_IMPORTED_MODULE_40__["MatSliderModule"], _angular_material_slide_toggle__WEBPACK_IMPORTED_MODULE_41__["MatSlideToggleModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_42__["MatSnackBarModule"], _angular_material_sort__WEBPACK_IMPORTED_MODULE_43__["MatSortModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_44__["MatTableModule"], _angular_material_tabs__WEBPACK_IMPORTED_MODULE_45__["MatTabsModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_46__["MatToolbarModule"], _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_47__["MatTooltipModule"], _angular_material_tree__WEBPACK_IMPORTED_MODULE_48__["MatTreeModule"], _angular_cdk_overlay__WEBPACK_IMPORTED_MODULE_49__["OverlayModule"], _angular_cdk_portal__WEBPACK_IMPORTED_MODULE_12__["PortalModule"], _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_62__["ScrollingModule"]],
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AppModule, [{
          ...
          args: [{
            ...
            exports: [_angular_cdk_a11y__WEBPACK_IMPORTED_MODULE_9__["A11yModule"], _angular_cdk_clipboard__WEBPACK_IMPORTED_MODULE_10__["ClipboardModule"], _angular_cdk_stepper__WEBPACK_IMPORTED_MODULE_13__["CdkStepperModule"], _angular_cdk_table__WEBPACK_IMPORTED_MODULE_14__["CdkTableModule"], _angular_cdk_tree__WEBPACK_IMPORTED_MODULE_15__["CdkTreeModule"], _angular_cdk_drag_drop__WEBPACK_IMPORTED_MODULE_11__["DragDropModule"], _angular_material_autocomplete__WEBPACK_IMPORTED_MODULE_16__["MatAutocompleteModule"], _angular_material_badge__WEBPACK_IMPORTED_MODULE_17__["MatBadgeModule"], _angular_material_bottom_sheet__WEBPACK_IMPORTED_MODULE_18__["MatBottomSheetModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_19__["MatButtonModule"], _angular_material_button_toggle__WEBPACK_IMPORTED_MODULE_20__["MatButtonToggleModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_21__["MatCardModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_22__["MatCheckboxModule"], _angular_material_chips__WEBPACK_IMPORTED_MODULE_23__["MatChipsModule"], _angular_material_stepper__WEBPACK_IMPORTED_MODULE_24__["MatStepperModule"], _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_25__["MatDatepickerModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_26__["MatDialogModule"], _angular_material_divider__WEBPACK_IMPORTED_MODULE_27__["MatDividerModule"], _angular_material_expansion__WEBPACK_IMPORTED_MODULE_28__["MatExpansionModule"], _angular_material_grid_list__WEBPACK_IMPORTED_MODULE_29__["MatGridListModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_30__["MatIconModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_31__["MatInputModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_32__["MatListModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_33__["MatMenuModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_34__["MatNativeDateModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_8__["MatPaginatorModule"], _angular_material_progress_bar__WEBPACK_IMPORTED_MODULE_35__["MatProgressBarModule"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_36__["MatProgressSpinnerModule"], _angular_material_radio__WEBPACK_IMPORTED_MODULE_37__["MatRadioModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_34__["MatRippleModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_38__["MatSelectModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_39__["MatSidenavModule"], _angular_material_slider__WEBPACK_IMPORTED_MODULE_40__["MatSliderModule"], _angular_material_slide_toggle__WEBPACK_IMPORTED_MODULE_41__["MatSlideToggleModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_42__["MatSnackBarModule"], _angular_material_sort__WEBPACK_IMPORTED_MODULE_43__["MatSortModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_44__["MatTableModule"], _angular_material_tabs__WEBPACK_IMPORTED_MODULE_45__["MatTabsModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_46__["MatToolbarModule"], _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_47__["MatTooltipModule"], _angular_material_tree__WEBPACK_IMPORTED_MODULE_48__["MatTreeModule"], _angular_cdk_overlay__WEBPACK_IMPORTED_MODULE_49__["OverlayModule"], _angular_cdk_portal__WEBPACK_IMPORTED_MODULE_12__["PortalModule"], _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_62__["ScrollingModule"]],
            bootstrap: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"]]
          }]
        }], null, null);
      })();
    ...
    /***/
    function hglL(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var CategorieService = /*#__PURE__*/function () {
        ...
        _createClass(CategorieService, [{
          ...
          key: "GetCategorieList",
          value: function GetCategorieList() {
            return this.http.get("".concat(this.baseUrl));
          }
        }, {
          key: "CreateCategorie",
          value: function CreateCategorie(categorie) {
            return this.http.post("".concat(this.baseUrl), categorie);
          }
        }, {
          key: "UpdateCategorie",
          value: function UpdateCategorie(id, value) {
            return this.http.put("".concat(this.baseUrl, "/").concat(id), value);
          }
        }, {
          key: "DeleteCategorie",
      ...
      CategorieService.ɵfac = function CategorieService_Factory(t) {
        return new (t || CategorieService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]));
      };
    ...
    /***/
    function jXNY(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "FilterContactPipe", function () {
      ...
      var FilterContactPipe = /*#__PURE__*/function () {
        function FilterContactPipe() {
          _classCallCheck(this, FilterContactPipe);
        }

        _createClass(FilterContactPipe, [{
          key: "transform",
          ...
          value: function transform(items, value, label) {
            ...
            return items.filter(function (e) {
              return e[label].toLowerCase().indexOf(value) === 0;
            });
          }
        }]);
      ...
      FilterContactPipe.ɵfac = function FilterContactPipe_Factory(t) {
        return new (t || FilterContactPipe)();
      };

      FilterContactPipe.ɵpipe = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefinePipe"]({
        name: "filterContact",
        type: FilterContactPipe,
        pure: true
      });
      /*@__PURE__*/

      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FilterContactPipe, [{
